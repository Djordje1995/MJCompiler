...
public class DesignatorNoParams extends DesignatorStatement {

    private Designator Designator;
    private MaybeActualParams MaybeActualParams;

    public DesignatorNoParams (Designator Designator, MaybeActualParams MaybeActualParams) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorNoParams(\n");
