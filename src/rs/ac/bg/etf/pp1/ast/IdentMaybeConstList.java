...
public class IdentMaybeConstList implements SyntaxNode {
    ...
    public IdentMaybeConstList (IdentMaybeConstList IdentMaybeConstList, String I2, MaybeAssignNumConst MaybeAssignNumConst) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IdentMaybeConstList(\n");
