...
public class InterfaceMethodDeclType extends InterfaceMethodDecl {

    private Type Type;
    private String I1;
    private MaybeFormPars MaybeFormPars;

    public InterfaceMethodDeclType (Type Type, String I1, MaybeFormPars MaybeFormPars) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("InterfaceMethodDeclType(\n");
