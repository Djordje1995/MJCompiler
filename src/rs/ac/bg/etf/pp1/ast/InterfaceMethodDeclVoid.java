...
public class InterfaceMethodDeclVoid extends InterfaceMethodDecl {

    private String I1;
    private MaybeFormPars MaybeFormPars;

    public InterfaceMethodDeclVoid (String I1, MaybeFormPars MaybeFormPars) {
        this.I1=I1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("InterfaceMethodDeclVoid(\n");
